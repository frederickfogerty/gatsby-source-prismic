...
export const TYPE_PATHS_KEY_TEMPLATE = 'gatsby-source-prismic %s %s'
...
export const FETCHING_WITH_RELEASE_REF_MSG =
  'Fetching documents using release named "%s" (ref: %s)'

export const COULD_NOT_FIND_MASTER_REF_MSG =
...
export const COULD_NOT_FIND_RELEASE_REF_MSG =
  'A ref could not be found for release with ID "%s".'

export const COULD_NOT_FIND_RELEASE_REF_WITH_FALLBACK_MSG =
  'A ref could not be found for release with ID "%s". The master ref will be used instead.'

export const COULD_NOT_FETCH_REPOSITORY_INFO_MSG =
  'The repository could not be accessed. Error message: %s'
